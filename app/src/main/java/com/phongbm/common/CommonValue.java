...
public class CommonValue {
    ...
    public static final String MESSAGE_LOG_LINK_AVATAR = "MESSAGE_LOG_LINK_AVATAR";
    public static final String MESSAGE_LOG_LINK_AVATAR_RECEVER = "MESSAGE_LOG_LINK_AVATAR_RECEVER";

    public static final String MESSAGE_SEND_EMOTION = "MESSAGE_SEND_EMOtION";
